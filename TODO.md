...
- [ ] **カラーパレット変更とUI改善** 🆕
  - [ ] **新カラーパレットの実装**
    - [ ] メインカラー: #3b3b6b（暗い紫/藍色）
    - [ ] サブカラー: #D24848（明るい赤）
    - [ ] アクセントカラー: #ccaf60（金色/黄土色）
    - [ ] 基本文字カラー: #191919（ほぼ黒）
    - [ ] Tailwind CSS設定ファイルの更新
  - [ ] **人間工学に基づくUI改善**
    - [ ] コントラスト比の最適化（WCAG AA準拠）
    - [ ] 視認性の向上（文字とボタンの可読性）
    - [ ] 長時間使用での目の疲労軽減
    - [ ] 色覚異常者への配慮
  - [ ] **アフォーダンス・シグニファイア最適化**
