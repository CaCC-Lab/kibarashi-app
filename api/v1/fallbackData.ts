...
export const fallbackSuggestions = {
  ...
  // 主婦・主夫向けフォールバックデータ - Phase A-2で追加
  housework: {
    5: [
      {
        id: 'hw_5_tea_break',
        title: 'お茶の時間でほっと一息 🍵',
        description: '忙しい家事の合間に、温かい飲み物で心を落ち着かせましょう',
        category: '認知的' as const,
        duration: 5,
        steps: [
          '手を洗って家事を一旦止める',
      ...
      {
        id: 'hw_5_window_breath',
        title: '窓辺での深呼吸',
        description: '自然の光と空気で、家事疲れをリセットしましょう',
        category: '認知的' as const,
        duration: 5,
        steps: [
          '窓に近づいて外を眺める',
      ...
      },
      {
        id: 'hw_5_quick_tidy',
        title: '5分間の達成感片付け',
        description: '小さな片付けで達成感を得て、心もスッキリさせましょう',
        category: '行動的' as const,
        duration: 5,
        steps: [
          '一つの場所を選ぶ（机、棚など）',
    ...
    15: [
      {
        id: 'hw_15_hand_massage',
        title: '家事疲れハンドケア 👐',
        description: '家事で疲れた手をいたわり、心身共にリラックスしましょう',
        category: '行動的' as const,
        duration: 15,
        steps: [
          'ハンドクリームを用意する',
      ...
      {
        id: 'hw_15_music_cleaning',
        title: 'ミュージック家事タイム',
        description: '好きな音楽と一緒に楽しく家事をして気分をアップ',
        category: '行動的' as const,
        duration: 15,
        steps: [
          'お気に入りの音楽をかける',
      ...
      {
        id: 'hw_15_recipe_planning',
        title: '献立プランニングタイム',
        description: '今日の料理を考えながら、創造性を刺激する時間',
        category: '認知的' as const,
        duration: 15,
        steps: [
          '冷蔵庫の中身をチェック',
    ...
    30: [
      {
        id: 'hw_30_cooking_meditation',
        title: 'マインドフル料理時間',
        description: '料理を通じて心を込める瞑想的な時間を過ごしましょう',
        category: '行動的' as const,
        duration: 30,
        steps: [
          '材料の色や形、香りを意識的に感じる',
      ...
      },
      {
        id: 'hw_30_home_spa',
        title: 'ホームスパタイム',
        description: 'お家で自分だけのリラクゼーション時間を作りましょう',
        category: '行動的' as const,
        duration: 30,
        steps: [
          'お風呂にゆっくり浸かる',
      ...
      {
        id: 'hw_30_family_photo',
        title: '家族の思い出タイム',
        description: '家族の写真を見ながら、幸せな記憶に浸る時間',
        category: '認知的' as const,
        duration: 30,
        steps: [
          'スマホやアルバムの家族写真を開く',
  ...
  childcare: {
    5: [
      {
        id: 'cc_5_deep_breath',
        title: '子育てママの深呼吸',
        description: '育児の忙しさから一瞬離れて、心を落ち着かせる呼吸法',
        category: '認知的' as const,
        duration: 5,
        steps: [
          '安全な場所で子どもを確認する',
      ...
      },
      {
        id: 'cc_5_self_praise',
        title: '子育て頑張り認定タイム',
        description: '今日の子育てを振り返り、頑張った自分を認めてあげましょう',
        category: '認知的' as const,
        duration: 5,
        steps: [
          '今日子どもにしてあげたことを3つ思い出す',
          '大変だったけど乗り越えたことを認める',
          '完璧でなくても「よく頑張った」と自分に言う',
          '明日も頑張る自分を想像してエールを送る'
        ]
      },
      {
        id: 'cc_5_child_watch',
        title: '子どもの寝顔でヒーリング',
        description: '静かに眠る子どもの姿を見て、愛おしさで心を満たしましょう',
        category: '認知的' as const,
        duration: 5,
        steps: [
          '眠っている子どもの傍に座る',
    ...
    15: [
      {
        id: 'cc_15_child_activity',
        title: '子どもと一緒にリラックス',
        description: '子どもと一緒に楽しめる活動で、双方の心を癒しましょう',
        category: '行動的' as const,
        duration: 15,
        steps: [
          '子どもと一緒に座る',
      ...
      },
      {
        id: 'cc_15_mom_time',
        title: 'ママ・パパだけの15分',
        description: '子どもが落ち着いている時に、自分だけの時間を作りましょう',
        category: '認知的' as const,
        duration: 15,
        steps: [
          '子どもが安全に遊んでいることを確認',
      ...
      {
        id: 'cc_15_outdoor_air',
        title: '親子で外の空気を吸う',
        description: 'ベランダや庭で新鮮な空気を吸い、気分転換しましょう',
        category: '行動的' as const,
        duration: 15,
        steps: [
          '子どもと一緒に外に出る',
    ...
    30: [
      {
        id: 'cc_30_creative_play',
        title: 'クリエイティブ親子時間',
        description: '子どもと一緒に創作活動を楽しみ、創造性を育みましょう',
        category: '行動的' as const,
        duration: 30,
        steps: [
          '画用紙とクレヨンを用意',
      ...
      {
        id: 'cc_30_gentle_exercise',
        title: '親子で軽い運動',
        description: '子どもと一緒に体を動かして、ストレス発散しましょう',
        category: '行動的' as const,
        duration: 30,
        steps: [
          'リビングにスペースを作る',
      ...
      },
      {
        id: 'cc_30_story_time',
        title: '物語の時間',
        description: '子どもと一緒に本の世界に浸り、想像力を育みましょう',
        category: '認知的' as const,
        duration: 30,
        steps: [
          'お気に入りの絵本を数冊選ぶ',
  ...
  shopping: {
    5: [
      {
        id: 'sh_5_mindful_walk',
        title: '買い物マインドフル歩行',
        description: '買い物の移動時間を利用して、心を整える歩行瞑想',
        category: '認知的' as const,
        duration: 5,
        steps: [
          '歩くペースをゆっくりにする',
      ...
      {
        id: 'sh_5_gratitude_shopping',
        title: '感謝のお買い物',
        description: '商品を手に取りながら、生産者や販売者への感謝を感じましょう',
        category: '認知的' as const,
        duration: 5,
        steps: [
          '手に取った商品をじっくり観察',
      ...
      {
        id: 'sh_5_window_enjoy',
        title: 'ウィンドウで目の保養',
        description: '綺麗なディスプレイを眺めて、美的感覚を刺激しましょう',
        category: '行動的' as const,
        duration: 5,
        steps: [
          '気になるお店のディスプレイを見る',
    ...
    15: [
      {
        id: 'sh_15_cafe_break',
        title: 'カフェでマインドフルネス',
        description: 'カフェの時間を利用して、心を落ち着かせ自分と向き合いましょう',
        category: '認知的' as const,
        duration: 15,
        steps: [
          'カフェやベンチを見つけて座る',
      ...
      {
        id: 'sh_15_nature_walk',
        title: '自然を感じる散歩',
        description: '商業施設の緑や公園で、自然のエネルギーを感じましょう',
        category: '行動的' as const,
        duration: 15,
        steps: [
          '近くの公園や緑のあるスペースを探す',
      ...
      {
        id: 'sh_15_people_watching',
        title: '人間観察でリフレッシュ',
        description: '人々の様子を観察して、人生の多様性を楽しみましょう',
        category: '認知的' as const,
        duration: 15,
        steps: [
          '落ち着いて座れる場所を見つける',
    ...
    30: [
      {
        id: 'sh_30_slow_shopping',
        title: 'スローショッピング体験',
        description: '急がずゆっくりと買い物を楽しみ、丁寧な時間を過ごしましょう',
        category: '行動的' as const,
        duration: 30,
        steps: [
          '買い物リストを確認して優先順位をつける',
      ...
      {
        id: 'sh_30_discovery_walk',
        title: '発見の散歩',
        description: '新しいお店や場所を発見して、好奇心を刺激しましょう',
        category: '行動的' as const,
        duration: 30,
        steps: [
          '普段通らない道や階を選んで歩く',
      ...
      {
        id: 'sh_30_creative_planning',
        title: '買い物クリエイティブタイム',
        description: '購入した食材で新しい料理を考える、創造的な時間',
        category: '認知的' as const,
        duration: 30,
        steps: [
          'カフェで購入した食材を並べる',
