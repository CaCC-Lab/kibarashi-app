...
function coerceRow(c, specDefault) {
  ...
  return {
    ...
    seasonal_events: coerceAxisColumn('seasonal_events', c.seasonal_events),
    energy_level: coerceAxisColumn('energy_level', c.energy_level),
    social_context: coerceAxisColumn('social_context', c.social_context),
    time_pressure: coerceAxisColumn('time_pressure', c.time_pressure),
